const Skills: React.FC = () => {
  ...
  return (
    <section id="expertise" className="min-screen px-4 sm:px-20 bg-custom-background-gray">
      ...
      <div className="font-space grid grid-cols-4 sm:grid-cols-8 lg:grid-cols-12 gap-0 pt-5">
        ...
        <div className="text-xl row-start-2 col-span-full lg:row-start-1 lg:col-start-7 font-space flex flex-wrap flex-row">
