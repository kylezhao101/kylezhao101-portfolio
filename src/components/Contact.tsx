...
const Contact: React.FC = () => {
    ...
    return (
        <section className="px-4 sm:px-20 pb-20 bg-custom-background-gray">

            <div className="grid grid-cols-4 sm:grid-cols-8 lg:grid-cols-12 gap-0">

                <div className='col-start-1 lg:col-start-2 col-span-8'>
                    <h2 className='font-neopixel text-5xl sm:text-7xl mb-10'>Get in touch</h2>
                </div>

                <div className='row-start-3  sm:col-start-1 sm:col-span-4 md:row-start-2 lg:col-start-2  font-space'>
                ...
                <div className='row-start-2 sm:col-start-1 sm:col-span-4 md:col-start-5 lg:col-span-3 lg:col-start-7 font-space mb-5'>
                    <a
